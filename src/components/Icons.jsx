...
// Общая библиотека векторных SVG-иконок для замены эмодзи и спецсимволов.
// Все иконки поддерживают stroke/fill currentColor и передачу размера.
...
export function IconMusic({ size = 16, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconLock({ size = 16, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
